...
// func (ur *userRepository) SavePost(postID int) error {
//     saved, err := ur.CheckIfPostSaved(postID)
//     if err != nil {
//         return err
//     }
//     if saved {
...
//     }
//     _, err = ur.DB.Exec("INSERT INTO saved_posts (user_id, post_id) VALUES (?, ?)", ur.UserID, postID)
//     if err != nil {
//         return err
//     }
//     return nil
...
// func (ur *userRepository) UnSavePost(postID int) error {
//     saved, err := ur.CheckIfPostSaved(postID)
//     if err != nil {
//         return err
//     }
...
//     }
//     _, err = ur.DB.Exec("DELETE FROM saved_posts WHERE user_id = ? AND post_id = ?", ur.UserID, postID)
//     if err != nil {
//         return err
//     }
//     return nil
...
// func (ur *userRepository) CheckIfPostSaved(postID int) (bool, error) {
//     var count int
//     err := ur.DB.QueryRow("SELECT COUNT(*) FROM saved_posts WHERE user_id = ? AND post_id = ?", ur.UserID, postID).Scan(&count)
//     if err != nil {
//         return false, err
//     }
//     return count > 0, nil
